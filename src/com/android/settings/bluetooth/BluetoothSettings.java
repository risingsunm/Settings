...
public final class BluetoothSettings extends DeviceListPreferenceFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        /*Begin: Modified by mashuai for Modify Bluetooth change screen direction keeping search 2012/08/16*/
        mActivityStarted = true;
        /*End: Modified by mashuai for Modify Bluetooth change screen direction keeping search 2012/08/16*/
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        menu.add(Menu.NONE, MENU_ID_SCAN, 0, textId)
                .setIcon(R.drawable.ic_scan_devices)
        ...
        menu.add(Menu.NONE, MENU_ID_RENAME_DEVICE, 0, R.string.bluetooth_rename_device)
                ...
                .setIcon(R.drawable.ic_bluetooth_rename_device)
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER);
        menu.add(Menu.NONE, MENU_ID_VISIBILITY_TIMEOUT, 0, R.string.bluetooth_visibility_timeout)
                .setEnabled(bluetoothIsEnabled)
                .setIcon(R.drawable.ic_bluetooth_visibility_timeout)
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER);
        menu.add(Menu.NONE, MENU_ID_SHOW_RECEIVED, 0, R.string.bluetooth_show_received_files)
                .setIcon(R.drawable.ic_bluetooth_show_received_files)
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER);
