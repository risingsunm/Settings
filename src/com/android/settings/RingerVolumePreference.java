...
/* mzikun modify for ring icon bug
...
*/
    private static final int[] SEEKBAR_MUTED_RES_ID = new int[] {
        R.drawable.ic_audio_vol_mute_ahong,
        R.drawable.ic_audio_ring_notif_mute_ahong,
        R.drawable.ic_audio_notification_mute_ahong,
        R.drawable.ic_audio_alarm_mute_ahong
    };
 ...
 */
    private static final int[] SEEKBAR_UNMUTED_RES_ID = new int[] {
        R.drawable.ic_audio_vol_ahong,
        R.drawable.ic_audio_ring_notif_ahong,
        R.drawable.ic_audio_notification_ahong,
        R.drawable.ic_audio_alarm_ahong
    };
            ...
            if (mCheckBoxes[i] != null) {
                if (streamType == AudioManager.STREAM_RING && muted
                    ...
                    mCheckBoxes[i].setImageResource(
                            R.drawable.ic_audio_ring_notif_vibrate_ahong);
                } else {
                    mCheckBoxes[i].setImageResource(
