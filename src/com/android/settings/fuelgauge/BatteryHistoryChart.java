...
//Begin: add by zaosheng, for debug, 2012-08-04
    private static final String TAG = "BatteryHistoryChart";
    private static final boolean DEBUG = false;
//End: add by zaosheng, for debug, 2012-08-04
...
//Begin: modified by zzaosheng, for text size, 2012-08-04
//        int textSize = 15;
        int textSize = 30;
...
//End: modified by zzaosheng, for text size, 2012-08-04
...
//Begin: add by zaosheng, for debug, 2012-08-04
        if(DEBUG)Log.d(TAG, "onSizeChanged() textHeight: " + textHeight + " mThinLineWidth: " + mThinLineWidth);
//End: add by zaosheng, for debug, 2012-08-04
...
//Begin: add by zaosheng, for debug, 2012-08-04
        if(DEBUG)Log.d(TAG, "onSizeChanged() mLargeMode: " + mLargeMode + " mLineWidth: " + mLineWidth);
//End: add by zaosheng, for debug, 2012-08-04
...
//Begin: modified by zzaosheng, for adjust the text location, 2012-08-04
//        if (mLargeMode) {
//            if (mHavePhoneSignal) {
...
//        }
        ...
        if (mLargeMode)
        {
            int offset = mLineWidth >> 1;
            if (mHavePhoneSignal) {
                canvas.drawText(mPhoneSignalLabel, 0,
                        height - mPhoneSignalOffset - mTextDescent - offset, mTextPaint);
            }
            if (mHaveGps) {
                canvas.drawText(mGpsOnLabel, 0,
                        height - mGpsOnOffset - mTextDescent - offset, mTextPaint);
            }
            if (mHaveWifi) {
                canvas.drawText(mWifiRunningLabel, 0,
                        height - mWifiRunningOffset - mTextDescent - offset, mTextPaint);
            }
            canvas.drawText(mWakeLockLabel, 0,
                    height - mWakeLockOffset - mTextDescent - offset, mTextPaint);
            canvas.drawText(mChargingLabel, 0,
                    height - mChargingOffset - mTextDescent - offset, mTextPaint);
            canvas.drawText(mScreenOnLabel, 0,
                    height - mScreenOnOffset - mTextDescent - offset, mTextPaint);
            canvas.drawLine(0, mLevelBottom+(mThinLineWidth/2), width,
                    mLevelBottom+(mThinLineWidth/2), mTextPaint);
            canvas.drawLine(0, mLevelTop, 0,
                    mLevelBottom+(mThinLineWidth/2), mTextPaint);
...
//End: modified by zzaosheng, for adjust the text location, 2012-08-04
