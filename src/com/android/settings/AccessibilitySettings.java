...
public class AccessibilitySettings extends SettingsPreferenceFragment implements DialogCreatable,
    ...
    private static final float LARGE_FONT_SCALE = 1.3f;    //mzikun modify for restore enlarge font size 20120608
    ...
    private void offerInstallAccessibilitySerivceOnce() {
        ...
        final boolean offerInstallService = !preferences.getBoolean(
                KEY_INSTALL_ACCESSIBILITY_SERVICE_OFFERED_ONCE, true);
