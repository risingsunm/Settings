...
import com.android.settings.mobilenetwork.MobileNetworkEnabler;
...
//mzikun add
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(LOG_TAG, "mzikun=======================settings oncreate");
    ...
    private void updateHeaderList(List<Header> target) {
        ...
        while (i < target.size()) {
            ...
            /*Begin: mzikun modify for settings menu*/
                ...
                Log.d(LOG_TAG, "id == R.id.mobile_network_settings");

                if (TelephonyManager.getDefault().isMultiSimEnabled()) {
//                    findPreference(KEY_MOBILE_NETWORK_SETTINGS).getIntent().setClassName(
//                            "com.android.phone", "com.android.phone.MSimSettings");
                    Log.d(LOG_TAG, "TelephonyManager.getDefault().isMultiSimEnabled()");
                    header.intent = new Intent("com.android.phone.MSimSettings_Action");
                }
...
//                    getPreferenceScreen().removePreference(findPreference(KEY_MOBILE_NETWORK_SETTINGS));
    ...
    private static class HeaderAdapter extends ArrayAdapter<Header> {
        ...
        private final MobileNetworkEnabler mMobileNetworkEnabler;
...
//            }
        ...
        public HeaderAdapter(Context context, List<Header> objects) {
            ...
            //mzikun add for settings menu
            mMobileNetworkEnabler = new MobileNetworkEnabler(context, new Switch(context));
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                switch (headerType) {
                    ...
                    /*Begin: mzikun modify for settings line height */
//                        view = mInflater.inflate(
//                                com.android.internal.R.layout.preference_header_item, parent,
//                                false);
                        view = mInflater.inflate(R.layout.preference_header_item_ahong, parent,false);
                    /*End: mzikun modify for settings line height */
...
//                    }
                    if (header.id == R.id.wifi_settings) {
                        ...
                        mMobileNetworkEnabler.setSwitch(holder.switch_);
                    }
/*End: mzikun modify for settings menu*/
        ...
        public void resume() {
            ...
            mMobileNetworkEnabler.resume(); //mzikun add for settings menu
        }

        public void pause() {
            mWifiEnabler.pause();
            mBluetoothEnabler.pause();
            mMobileNetworkEnabler.pause(); //mzikun add for settings menu
        }
    ...
    /*Begin: mzikun add for battery low intent*/
    public static class SavingModeActivity extends Settings { /* empty */ }
    /*End: mzikun add for battery low intent*/
}
