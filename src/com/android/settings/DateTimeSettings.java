...
public class DateTimeSettings extends SettingsPreferenceFragment
    ...
    /* begin:mzikun add for date time bug */
    private boolean isCardAbsent() {
        ...
        if ((telManager.getSimState(cdma_id) == TelephonyManager.SIM_STATE_ABSENT) &&
                (telManager.getSimState(gsm_id) == TelephonyManager.SIM_STATE_ABSENT)) {
            return true;
        } else {
            return false;
        }
    ...
    /* end:mzikun add for date time bug */
